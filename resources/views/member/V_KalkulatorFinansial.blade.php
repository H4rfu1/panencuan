				  ...
				  <div class="card-details">
					...
					<div class="row">
					  <div class="form-group col-sm-12">
						<input id="nominal" type="number" class="form-control mb-2" name="nominal (Rupiah)" placeholder="Nominal" required aria-label="Card Holder" aria-describedby="basic-addon1" value="{{$nominal}}">
						...
						<input id="waktu" type="number" class="form-control" name="waktu (Tahun)" placeholder="Jangka Waktu" required aria-label="Card Holder" aria-describedby="basic-addon1" value="{{$waktu}}">
					  </div>
					  <div class="form-group col-sm-12">
