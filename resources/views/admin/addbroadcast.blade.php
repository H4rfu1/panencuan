                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_title">
                                    <h2>Tambah Broadcast {{$data->opsi ." ".$data->judul}}
                                ...
                                @endif
                                <div class="x_content">
                                    <form class="" action="{{url('kirimbroadcast')}}" method="post" novalidate enctype="multipart/form-data">
                                      @csrf
                                      <input type="hidden" name="id" value="{{$data->id_webinar_livekelas}}">
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Deskripsi<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <textarea class="form-control" type="text"  name="deskripsi" placeholder="Isi broadcast" required="required"></textarea>
                                            </div>
                                        </div>
